...
from flex.db.model.pools import StakingPool, FarmingPool, CometaPool
...
async def all_contracts_to_pools() -> dict:
    created_pools = []
    ...
    logger.info(f'Failed to process contracts: {failed_contract_ids}')

    return {
        'created_count': len(created_pools),
